...
def fetch_local_html_path(season, page):
    return f'../../Data/Lake/1B_Output_Salary/html/season={str(season)},page={str(page)}.html'


def fetch_local_csv_path(season):
    dir_path = '../../Data/Lake/1B_Output_Salary/dataframe'
    if not os.path.exists(dir_path):
        os.makedirs(dir_path)
    return f'../../Data/Lake/1B_Output_Salary/dataframe/season={str(season)}.csv'
