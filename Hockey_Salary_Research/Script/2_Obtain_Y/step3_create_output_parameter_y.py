...
import step2_create_local_salary_dataframe


def fetch_salary_cap_csv_path():
    return '../../Data/Lake/1B_Output_Salary/SALARY_CAP.csv'
...
def main():
    ...
    for season in range(2008, 2025):
        csv_file_path = step2_create_local_salary_dataframe.fetch_local_csv_path(season)
        ...
        df_season.to_csv(step2_create_local_salary_dataframe.fetch_local_csv_path(season), index=False, encoding='utf-8')
